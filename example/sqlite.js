...
var SQLite3 = ffi.Library("libsqlite3", {
  ...
  sqlite3_exec: [
    "int",
    [sqlite3Ptr, "string", sqlite3_exec_callback, "void *", stringPtr],
  ],
});
...
var callback = ffi.Callback(
  "int",
  ["void *", "int", stringPtr, stringPtr],
  function (tmp, cols, argv, colv) {
    var obj = {};
