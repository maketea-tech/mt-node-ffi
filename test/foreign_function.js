var assert = require("assert"),
  ...
  Array = require("mt-node-ref-array"),
  Struct = require("mt-node-ref-struct"),
  ffi = require("../"),
...
describe("ForeignFunction", function () {
  ...
  it('should call the static "double_box_ptr" bindings', function () {
    ...
    var double_box_ptr = ffi.ForeignFunction(bindings.double_box_ptr, box, [
      boxPtr,
    ]);
    var b = new box();
    b.width = 4;
  ...
  it('should call the static "area_box_ptr" bindings', function () {
    var boxPtr = ref.refType(box);
    var area_box = ffi.ForeignFunction(bindings.area_box_ptr, ref.types.int, [
      boxPtr,
    ]);
    var b = new box({ width: 5, height: 20 });
  ...
  it('should call the static "create_box" bindings', function () {
    var create_box = ffi.ForeignFunction(bindings.create_box, box, [
      "int",
      "int",
    ]);
  ...
  it('should call the static "add_boxes" bindings', function () {
    ...
    var boxPtr = ref.refType(box);
    var add_boxes = ffi.ForeignFunction(bindings.add_boxes, box, [
      boxPtr,
      "int",
    ]);
  ...
  it('should call the static "int_array" bindings', function () {
    ...
    var int_array = ffi.ForeignFunction(bindings.int_array, IntArray, [
      IntArray,
    ]);
  ...
  it('should call the static "array_in_struct" bindings', function () {
    var array_in_struct = ffi.ForeignFunction(bindings.array_in_struct, arst, [
      arst,
    ]);
    var a = new arst();
  ...
  it('should call the static "test_169" bindings', function () {
    ...
    var test = ffi.ForeignFunction(bindings.test_ref_56, "int", [
      ref.refType(Obj56),
    ]);
